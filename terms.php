...
<head>
    ...
    <title>Warunki i postanowienia</title>
    ...
    <div class="top-menu">
        <div class="search">
            ...
            <ul>
                ...
                <li class="active"><a href="terms.php">Warunki i postanowienia</a></li>
    ...
    <div class="container">
        ...
        <div class="contact-details">
            ...
            <div class="col-md-6 company_address">
                ...
                <p>Wesoła 05/54, 74-517 Kościerzyna</p>

                <p>+9919480117823</p>

                <p>marcelina.kazmierczak@majewski.com</p>
